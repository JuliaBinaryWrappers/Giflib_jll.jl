...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Giflib_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("59f7168a-df46-5410-90c8-f2779963d0ec"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Giflib", artifacts_toml) for e in artifacts["Giflib"]]
...
if best_platform === nothing
    @debug("Unable to load Giflib; unsupported platform $(triplet(platform_key_abi()))")
else
